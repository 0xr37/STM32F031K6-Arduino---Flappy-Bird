...
void activatePipes(int spawnGap){
	if ((pipes[0].active) && (pipes[1].active == 0) && (pipes[0].x <= (MAXSCREENX - spawnGap - pipes[0].width))){
		pipes[1].active = 1;
	}
	if ((pipes[1].active) && (pipes[2].active == 0) && (pipes[1].x <= (MAXSCREENX - spawnGap - pipes[1].width))){
		pipes[2].active = 1;
	}
	if ((pipes[2].active) && (pipes[0].active == 0) && (pipes[2].x <= (MAXSCREENX - spawnGap - pipes[2].width))){
		pipes[0].active = 1;
	}
}
